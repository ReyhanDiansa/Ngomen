...
const index = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const { data } = await GetMovieDetail({ movieId: movieId });
          ...
          <>
            <div className="mx-2 md:mx-14  my-10 md:my-5">
              ...
              <div className="bg-white px-5 py-10 my-4 rounded-sm">
                {detailMovie?.production_companies?.length > 0 && (
                  <div className="flex justify-between py-3">
                    <p className="w-6/12 font-semibold">Production Companies</p>
                    <p className="p-1">:</p>
                    <div className="w-8/12 flex gap-2 flex-wrap">
                ...
                {detailMovie?.production_countries?.length > 0 && (
                  <div className="flex justify-between py-3">
                    <p className="w-6/12 font-semibold">Production Countries</p>
                    <p className="p-1">:</p>
                    <div className="w-8/12 flex gap-2 flex-wrap">
              ...
              {/* User's Review */}
              {movieId && <MovieReview movieId={movieId} />}
            </div>
            <div>
              <Footer />
            </div>
